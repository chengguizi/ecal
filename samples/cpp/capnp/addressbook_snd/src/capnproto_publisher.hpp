    ...
    **/
    ...
    private:
      ...
      **/
      ...
      {
        // https://groups.google.com/g/capnproto/c/dr2mfwWrKCw/m/e6ChPUhUCgAJ
        // TODO: recode kj::Array<word> messageToFlatArray for minimising copy
        // https://github.com/capnproto/capnproto/blob/master/c++/src/capnp/serialize.c++
    ...
    **/
    ...
    public:
      ...
      **/
      ...
      bool Send()
      {
        return publisher.Send(builder) > 0 || !publisher.IsSubscribed();
      }

      // Added this function so we can re-build message every time, outside the publisher
      bool Send(const capnp::MallocMessageBuilder& builder)
      {
        return publisher.Send(builder) > 0 || !publisher.IsSubscribed();
      }
      ...
      void EnableZeroCopy()
      {
        publisher.ShmEnableZeroCopy(true);
        publisher.ShmSetBufferCount(2);
      }

      // should be called after Create()
      void EnableTCPTransport()
      {
        publisher.SetLayerMode(eCAL::TLayer::tlayer_tcp, eCAL::TLayer::smode_on);
        publisher.SetLayerMode(eCAL::TLayer::tlayer_shm, eCAL::TLayer::smode_off);
      }
      ...
      **/
      ...
      CBuilderPublisher& GetPublisher()
      {
        return publisher;
      }
